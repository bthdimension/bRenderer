...
SvgPanZoom.prototype.handleDblClick = function(evt) {
  ...
  zoomFactor = (1 + this.options.zoomScaleSensitivity) * 2		// zoom in
  var zoom = this.getZoom();
  if (this.getZoom() * zoomFactor > this.options.maxZoom) {
    zoomFactor = 1/((1 + this.options.zoomScaleSensitivity) * 2) // zoom out 
  } 
