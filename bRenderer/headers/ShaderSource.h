...
namespace bRenderer
{
	...
	//Begin
	static std::string shader_source_function_vertex_main_begin(bool hasLighting, bool hasTextures, bool normalMap)
	{
		std::string main =
	...
	// Lighting
	static std::string shader_source_function_lighting(GLuint maxLights, bool specularColor, bool normalMap, bool diffuseLighting, bool specularLighting, bool variableNumberOfLights)
	{
		std::string lighting = "";
		for (GLuint light_number = 0; light_number < maxLights; light_number++){
			std::string num = lexical_cast<std::string>(light_number);
	...
	static std::string shader_source_function_fragment_finalize_diffuse(bool diffuseColor, bool diffuseMap)
	{
	...
	static std::string shader_source_function_fragment_finalize_specular(bool specularColor, bool specularMap)
	{
