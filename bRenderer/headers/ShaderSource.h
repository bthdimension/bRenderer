...
/* Vertex Shader */
	...
	static std::string shader_source_function_vertex_main_begin(bool normalMap)
	{
		std::string main = 
			...
			+ "posVaryingViewSpace = " + DEFAULT_SHADER_UNIFORM_VIEW_MATRIX + "*" + DEFAULT_SHADER_UNIFORM_MODEL_MATRIX + "*" + DEFAULT_SHADER_ATTRIBUTE_POSITION + SHADER_SOURCE_LINE_ENDING
			+ "texCoordVarying = " + DEFAULT_SHADER_ATTRIBUTE_TEXCOORD + SHADER_SOURCE_LINE_ENDING;
		if (!normalMap)
			main += "normalVaryingViewSpace = mat3(" + DEFAULT_SHADER_UNIFORM_VIEW_MATRIX + ")*" + DEFAULT_SHADER_ATTRIBUTE_NORMAL + SHADER_SOURCE_LINE_ENDING;
		return main;
	}
	// TBN for normal map
	const std::string SHADER_SOURCE_FUNCTION_VERTEX_MAIN_TBN =
		+"vec3 vertexNormal_ViewSpace = mat3(" + DEFAULT_SHADER_UNIFORM_VIEW_MATRIX + ") * mat3(" + DEFAULT_SHADER_UNIFORM_MODEL_MATRIX + ") * " + DEFAULT_SHADER_ATTRIBUTE_NORMAL + SHADER_SOURCE_LINE_ENDING
		+ "vec3 vertexTangent_ViewSpace = mat3(" + DEFAULT_SHADER_UNIFORM_VIEW_MATRIX + ") * mat3(" + DEFAULT_SHADER_UNIFORM_MODEL_MATRIX + ") * " + DEFAULT_SHADER_ATTRIBUTE_TANGENT + SHADER_SOURCE_LINE_ENDING
		+ "vec3 vertexBitangent_ViewSpace = mat3(" + DEFAULT_SHADER_UNIFORM_VIEW_MATRIX + ") * mat3(" + DEFAULT_SHADER_UNIFORM_MODEL_MATRIX + ") * " + DEFAULT_SHADER_ATTRIBUTE_BITANGENT + SHADER_SOURCE_LINE_ENDING
...
/* Fragment Shader */
	...
	// Ambient
	const std::string SHADER_SOURCE_FUNCTION_FRAGMENT_AMBIENT = "vec4 ambient  = vec4(clamp(" + DEFAULT_SHADER_UNIFORM_AMBIENT_COLOR + "+" + WAVEFRONT_MATERIAL_AMBIENT_COLOR + ", 0.0, 1.0), 0.0)" + SHADER_SOURCE_LINE_ENDING;
